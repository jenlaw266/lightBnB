...
const getAllProperties = function (options, limit = 10) {
  //input from options: city, owner_id, minimum_price_per_night, maximum_price_per_night, minimum_rating
  const queryParams = [];
  ...
  if (options.maximum_price_per_night && options.maximum_price_per_night) {
    whereOrAnd();
